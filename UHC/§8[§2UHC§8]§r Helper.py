def SayingConfig(e):
	...
	#
	Com = '/tellraw '+str(e.player.getName())+' ["",{"text":"[","color":"dark_gray"},{"text":"UHC","color":"dark_red"},{"text":"]","color":"dark_gray"},{"text":" - ","color":"gray"},{"text":"'+str(Name)+'","color":"dark_purple"},{"text":"\n"},{"text":"[","color":"dark_gray"},{"text":"UHC","color":"dark_red"},{"text":"] ","color":"dark_gray"},{"text":"----| ","color":"gray"},{"text":"Players","color":"dark_aqua"},{"text":" |----","color":"gray"}]'
	e.npc.executeCommand(Com)

	List = ["BotNumber","TeamSize"]
	for i in range(0, len(List)):
		Com = '/tellraw @a ["",{"text":"[","color":"dark_gray"},{"text":"UHC","color":"dark_red"},{"text":"]","color":"dark_gray"},{"text":" - ","color":"gray"},{"text":"'+str(List[i])+'","color":"aqua"},{"text":" : ","color":"gray"},{"text":"'+str(e.npc.world.getTempdata().get(str(List[i])))+'","color":"white"}]'
		e.npc.executeCommand(Com)

	Com = '/tellraw '+str(e.player.getName())+' ["",{"text":"[","color":"dark_gray"},{"text":"UHC","color":"dark_red"},{"text":"] ","color":"dark_gray"},{"text":"----| ","color":"gray"},{"text":"Timers","color":"dark_aqua"},{"text":" |----","color":"gray"}]'
	e.npc.executeCommand(Com)
	...
	Com = '/tellraw '+str(e.player.getName())+' ["",{"text":"[","color":"dark_gray"},{"text":"UHC","color":"dark_red"},{"text":"] ","color":"dark_gray"},{"text":"----| ","color":"gray"},{"text":"Scenarios","color":"dark_aqua"},{"text":" |----","color":"gray"}]'
	e.npc.executeCommand(Com)
	...
	Com = '/tellraw '+str(e.player.getName())+' ["",{"text":"[","color":"dark_gray"},{"text":"UHC","color":"dark_red"},{"text":"] ","color":"dark_gray"},{"text":"----| ","color":"gray"},{"text":"Other infos","color":"dark_aqua"},{"text":" |----","color":"gray"}]'
	e.npc.executeCommand(Com)
